        ...
        <div className="row align-items-center mb-5 g-4">
          ...
          <div className="col-md-6">
            <div className="px-3 px-md-5">
              ...
              <div className="mt-3">
                <a
                  href="https://github.com/Prinkal1316/email-spam-detection" // ← Replace with actual live demo link
                  target="_blank"
        ...
        <div className="row align-items-center mb-5 g-4 flex-md-row-reverse">
          ...
          <div className="col-md-6">
            <div className="px-3 px-md-5">
              ...
              <div className="mt-3">
                <a
                  href="https://github.com/Prinkal1316/attendance-system" // ← Replace with actual live demo link
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn btn-light me-3"
                >
